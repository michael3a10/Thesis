...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[
        ...
        level 2 concept/.append style={font=\normalsize, level distance=4cm, sibling angle=45},
        ...
        child[concept color=green!50] { node[font=\bfseries] {Needs}
            ...
            child { node {Global adoption} }
        }
        child[concept color=purple!50] { node[font=\bfseries] {Proposed Solution}
            [clockwise from=200]
            child { node {DMF Platform} }
            child { node {EC sensors} }
            child { node {Real-time localized verification} }
